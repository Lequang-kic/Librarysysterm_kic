...
public class IssueBookForm extends JFrame {
	...
	private JTextField textField_4;
		...
		btnIssueBook.addActionListener(new ActionListener() {
			...
			if(i>0){
				JOptionPane.showMessageDialog(IssueBookForm.this,"Book issued successfull!");
				LibrarianSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(IssueBookForm.this,"have a problem");
			}
			
			}else{
				JOptionPane.showMessageDialog(IssueBookForm.this,"Callno doesn't exist!");
			}
