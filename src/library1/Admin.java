...
public class Admin extends JFrame {
	...
	public Admin() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(name.equals("lequang")&&password.equals("s18009")){
				AdminSuccess.main(new String[]{});
				frame.dispose();
			}else{
				JOptionPane.showMessageDialog(Admin.this, "Username or Password Error","Login Error!", JOptionPane.ERROR_MESSAGE);
				textField.setText("");
